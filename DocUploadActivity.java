...
public class DocUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doc_upload); imageView = (ImageView) findViewById(R.id.imageView);
        et1 = (EditText) findViewById(R.id.et_title);
        et2 = (EditText) findViewById(R.id.et_shortdesc);
        et3 = (EditText) findViewById(R.id.et_rating);
        et4 = (EditText) findViewById(R.id.et_price);
        et5 = (EditText) findViewById(R.id.et_longdesc);
        ...
        buttonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (et1.getText().toString().trim().isEmpty()&& et2.getText().toString().trim().isEmpty()&& et3.getText().toString().trim().isEmpty()&& et4.getText().toString().trim().isEmpty()&& et5.getText().toString().trim().isEmpty()) {
                    ...
                    et3.setError("Enter tags first");
                    et4.setError("Enter tags first");
                    et5.setError("Enter tags first");
                    et1.requestFocus();
                    et2.requestFocus();
                    et3.requestFocus();
                    et4.requestFocus();
    ...
    * */
    ...
    private void uploadBitmap(final Bitmap bitmap) {
        ...
        final String shortdesc = et2.getText().toString().trim();
        final String rating = et3.getText().toString().trim();
        final String price = et4.getText().toString().trim();
        final String longdesc = et5.getText().toString().trim();

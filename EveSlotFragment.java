...
public class EveSlotFragment extends Fragment implements View.OnClickListener{
    ...
    private void loadslots(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://anujagrawalpm.000webhostapp.com/appointment/timeslots.php?"+"docname="+docname.replace(" ", "%20")+"&day="+day+"&daytime=Evening",
